        ...
        <div className="flex flex-col gap-4 lg:gap-6">
          <div>
            ...
            <div className="animate-slide-up-delay-1">
              <h1 className="text-gray-800 text-3xl sm:text-4xl md:text-5xl lg:text-3xl xl:text-5xl font-bold font-['Roboto'] leading-tight">
                <div className="flex items-center gap-4 ml-14 md:justify-start sm:ml-1 lg:text-3xl xl:text-5xl ">
                  I create{" "}
                  <RotatingText
                    texts={[
                      "React apps",
                    ...
                    mainClassName="w-fit auto text-[#5E3BEE] overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg md:tetx"
                    staggerFrom={"last"}
                    initial={{ y: "100%" }}
